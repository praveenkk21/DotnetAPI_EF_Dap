...
public class UserController : ControllerBase
{
    ...
    {
        string sql = "UPDATE PraveenSchema.UserSalary SET Salary=" 
    ...
    {
        string sql = "DELETE FROM PraveenSchema.UserSalary WHERE UserId=" + userId.ToString();
    ...
    {
        string sql = "UPDATE PraveenSchema.UserJobInfo SET Department='" 
    ...
    // {
    //     string sql = "DELETE FROM PraveenSchema.UserJobInfo  WHERE UserId=" + userId;
